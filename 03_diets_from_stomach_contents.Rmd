...
#export
write.csv(prey.pro.functional, "Outputs/Stomach Contents/Diet/Post-Invasion/post_prey_pro_functional.csv")
```
...
pre.stomachs.raw <- read.csv(file = "Data/Stomach Contents/FCE1259_All_Specimen_by_Number_Correct.csv")
```
...
write.csv(pre.post.nmds.consumers, "Outputs/Stomach Contents/Diet/Pre-vs-Post-Invasion/pre_post_nmds_consumers.csv")
...
write.xlsx(
  ...
  "Outputs/Stomach Contents/Diet/Pre-vs-Post-Invasion/pre_post_pairwise_permanova.xlsx",
  rowNames = T
)
```
