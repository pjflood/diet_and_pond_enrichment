...
write.xlsx(aovp.summary, file = "Outputs/Stomach Contents/Trophic Position/aovp_summary.xlsx")
```
...
write.xlsx(trophic.comarisons.05, file = "Outputs/Stomach Contents/Trophic Position/significant_trophic_position_comparisons.xlsx")
```
...
write.xlsx(all.trophp.mean.sd, "Outputs/Stomach Contents/Trophic Position/all_post-invasion_trophic_positions.xlsx")
```
...
```{r}
#load data
pre.trophp <- read.csv("Data/Stomach Contents/pre-invasion_individual_trophic_positions.csv")
...
write.xlsx(pre.post.aovp.summary, file = "Outputs/Stomach Contents/pre_post_aovp_summary.xlsx")
```
...
write.xlsx(pre.post.trophic.comarisons.05, file = "Outputs/Stomach Contents/pre_post_trophic_position_comparisons.xlsx")
```
...
write.xlsx(list("All_Pre_Post" = pre.post.trophp.wide, "Pre_Post_with_Stats" = pre.post.wide.stat, "Pre_Post_Significant" = pre.post.wide.stat.05), 
           file = "Outputs/Stomach Contents/pre_post_mean_sd_trophp_stats.xlsx")
```
